...
alter policy "activity_logs_select" on public.activity_logs
  using (((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1)));
alter policy "activity_logs_insert" on public.activity_logs
  with check (((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1)));
-- ai_chat_history
alter policy "ai_chat_history_delete" on public.ai_chat_history
  using ((((EXISTS ( SELECT 1 FROM users u WHERE ((u.auth_user_id = (select auth.uid())) AND (u.id = ai_chat_history.user_id)))) OR ((select get_user_role((select auth.uid()))) = 1)) AND ((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1))));
...
alter policy "notifications_delete" on public.notifications
  using (((EXISTS ( SELECT 1 FROM users u WHERE ((u.auth_user_id = (select auth.uid())) AND (u.id = notifications.user_id)))) AND ((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1))));
alter policy "notifications_insert" on public.notifications
  with check (((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1)));
alter policy "notifications_select" on public.notifications
  using ((((user_id IS NULL) OR (EXISTS ( SELECT 1 FROM users u WHERE ((u.auth_user_id = (select auth.uid())) AND (u.id = notifications.user_id))))) AND ((factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1))));
...
alter policy "settings_insert" on public.settings
  with check (((select get_user_role((select auth.uid()))) = 1));
...
alter policy "users_delete" on public.users
  using (((select get_user_role((select auth.uid()))) = 1));
alter policy "users_insert" on public.users
  with check (((select get_user_role((select auth.uid()))) = 1));
alter policy "users_select" on public.users
  using (((auth_user_id = (select auth.uid())) OR (factory_id = (select get_user_factory_id((select auth.uid())))) OR ((select get_user_role((select auth.uid()))) = 1)));
alter policy "users_update" on public.users
  using (((auth_user_id = (select auth.uid())) OR ((select get_user_role((select auth.uid()))) = 1)));
